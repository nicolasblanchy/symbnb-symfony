    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add(
                'slug', 
                TextType::class, 
                $this->getConfiguration('Chaine URL',"Tapez l'adresse web (automatique)", [
                    'required' => false
                ])
            )
            ->add(
                'coverImage', 
                UrlType::Class, 
                $this->getConfiguration('Url de l\'image détaillée', "Donnez l'adresse d'une image qui donne vraiment envie  !")
            )
            ->add(
                'introduction', 
                TextType::class, 
            ...
            ->add(
                'price', 
                MoneyType::class, 
                $this->getConfiguration('Prix par nuit',"Entrez le prix que vous voulez pour une nuit")
            )
            ->add(
                'images',
