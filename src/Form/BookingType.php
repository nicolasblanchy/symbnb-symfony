...
class BookingType extends ApplicationType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('endDate', TextType::class, $this->getConfiguration("Date de départ", "La date à laquelle vous quitterez les lieux"))
        ...
        ;
        // permet de transformer les dates de chaîne de caractère en format date
