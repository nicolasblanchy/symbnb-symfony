...
class Booking
{
    ...
    /**
     * Callback applelé à chaque fois qu'on créé une réservation
     *
     * @ORM\PrePersist
     * 
     * @return void
    ...
    public function isBookableDates(){
        ...
        // Tableau quicontient des chaînes de carractères de mes journées
        $days = array_map($formatDay, $bookingDays);

        // Tableau qui contient des chaînes de carractères des jours non disponibles
        $notAvailable = array_map($formatDay, $notAvailableDays);

        // On teste pour savoir si au moins une date est présente dans le tableau $notAvailable, si c'est le cas on retourne false, sinon on retourne true
        foreach($days as $day){
